...
if (isset($_GET['folder'])) {
    ...
    if ($conn->query($query) === TRUE) {
        ...
        $output .= '<a href="#"><i class="fas fa-folder-open yellow folder-icon"></i> <span>' . $folderName . '</span><i class="fas fa-plus add-icon" data-attrib-id="' . $newItemId . '" onclick="clickaddbutton(' . $newItemId . ')"></i> <i class="fas fa-trash delete-icon" data-attrib-id="' . $newItemId . '"></i></a></li>';
    ...
    if ($conn->query($query) === TRUE) {
        ...
        $output .= '<a href="#"><span>' . $linkName . '</span><i class="fas fa-trash delete-icon" data-attrib-id="' . $newItemId . '"></i></a></li>';
        echo $output;
    } else {
